...
<div class="wrap">
  ...
  <div class="hero">
    ...
    <p class="hero-sub">Computer Systems Engineering undergraduate at NED University of Engineering & Technology[cite: 1]. Building at the intersection of machine learning, embedded AI, and real-world safety systems.</p>
    <div class="hero-links">
      ...
      <a class="pill"><i class="ti ti-map-pin"></i>Karachi, Pakistan</a>
    </div>
  </div>
  ...
  <div class="stats-row">
    ...
    <div class="stat"><div class="stat-num">220+</div><div class="stat-label">LeetCode problems[cite: 1]</div></div>
  </div>
  ...
  <div class="projects">
    ...
    <div class="proj featured">
      ...
      <p class="proj-desc">Binary classification system predicting <strong>construction site fatalities</strong> from multi-source NYC data[cite: 1]. Collected and merged data from NYC OpenData, OpenWeatherMap Historical API, and DOB Permit Issuance datasets to build a custom 1,253-row dataset with 27 features[cite: 1]. Trained five ML algorithms — Logistic Regression, KNN, SVM, Naive Bayes, and ANN — with <strong>incremental learning</strong> for continuous model updates without full retraining[cite: 1]. Applied SMOTE, IQR outlier treatment, standardisation, and geospatial fatality mapping.</p>
    ...
    <div class="proj embedded">
      ...
      <p class="proj-desc">Real-time IoT-based LPG gas leakage detection system with <strong>automated alarms and instant mobile alerts</strong> via the Blynk platform[cite: 1]. Detects dangerous gas concentrations and notifies users immediately, designed for residential and industrial deployment.</p>
      <div class="proj-footer">
        <div class="tags">
    ...
    <div class="proj net">
      ...
      <p class="proj-desc">High-performance network security solution combining <strong>Software Defined Networking with end-to-end encryption</strong> and Zero Trust access control[cite: 1]. Implements dynamic traffic filtering and secure communication channels at the network layer.</p>
      <div class="proj-footer">
        <div class="tags">
    ...
    <div class="proj algo">
      ...
      <p class="proj-desc">Built a research tool mapping citation networks as an interactive graph using a hybrid BM25 + dense retrieval pipeline, with automated, source-traceable report generation using Gemini API[cite: 1].</p>
      <div class="proj-footer">
        <div class="tags">
    ...
    <div class="proj hw">
      ...
      <p class="proj-desc">Designed a <strong>basic processor, MIPS architecture simulation</strong>, and a world clock using logic gates and multiplexers. Built and simulated combinational and sequential circuits using Verilog HDL[cite: 1] and Logisim[cite: 1].</p>
      <div class="proj-footer">
        <div class="tags">
  ...
  <div class="certs">
    <div class="cert"><div class="cert-dot"></div><span class="cert-name">AI Fundamentals</span><span class="cert-org">Google</span>[cite: 1]</div>
    <div class="cert"><div class="cert-dot"></div><span class="cert-name">Introduction to Machine Learning</span><span class="cert-org">Duke University</span>[cite: 1]</div>
    <div class="cert"><div class="cert-dot"></div><span class="cert-name">Shallow Neural Networks</span><span class="cert-org">DeepLearning Institute</span>[cite: 1]</div>
    <div class="cert"><div class="cert-dot"></div><span class="cert-name">Generative AI Explained</span><span class="cert-org">NVIDIA DLI</span>[cite: 1]</div>
    <div class="cert"><div class="cert-dot"></div><span class="cert-name">Introduction to Generative AI</span><span class="cert-org">NVIDIA DLI</span>[cite: 1]</div>
    <div class="cert"><div class="cert-dot"></div><span class="cert-name">IoT with ESP32 and ESP8266</span><span class="cert-org">NCL NEDUET</span>[cite: 1]</div>
  </div>

  <div class="section-label">Education</div>

  <div class="edu">
    <div class="edu-name">NED University of Engineering & Technology[cite: 1]</div>
    <div class="edu-meta">BE — Computer Systems Engineering &nbsp;·&nbsp; 2023 – Present &nbsp;·&nbsp; CGPA 3.47[cite: 1]</div>
    <p class="edu-desc">Relevant coursework: Machine Learning[cite: 1], Data Structures and Algorithms[cite: 1], Embedded Systems[cite: 1], Digital Logic Design[cite: 1], Object-Oriented Programming[cite: 1].</p>
  </div>
